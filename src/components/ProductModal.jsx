function ProductModal({ modalType, templateProduct, handleModelInputChange, handleAddImage, handleRemoveImage, updateProductData, deleteProductData, closeModal }) {
    return (<div
        id="productModal"
